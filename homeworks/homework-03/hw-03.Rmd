...
>Total likelihood for hot hand model is $(p_B)^{10}(1-p_B)^{15}$

>Total likelihood for hot hand is $(p_B^7)(p_{B|B})^1(1-p_{B|B})^7(1-p_B)^{10}$
...
| 2 | MBMBM | $(p_B)^2(1-p_B)^3$ | $(p_B)^2(p_{B|B})^0(1-p_{B|B})^3(1-p_B)^0$ |
| 3 | MMBBB | $(p_B)^3(1-p_B)^2$ | $(p_B)^1(p_{B|B})^0(1-p_{B|B})^2(1-p_B)^2$ |
